...
actual object Intents {
    ...
    actual fun inviteFriends() {
        val sendIntent = Intent().apply {
            ...
            type = "text/plain"
            putExtra(Intent.EXTRA_TEXT, "Hey! I'm using SplitBill to split expenses. It makes sharing bills and expenses super easy! Join me here: https://play.google.com/store/apps/details?id=com.potato.split")
